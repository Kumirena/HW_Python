...
N = abs(int(input('Если English - введите 1, если Russian - введите 0: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('Стоимость слова', sum([k for i in word for k, v in English.items() if i in v]), 'очков')
elif N == 0:
	print('Стоимость слова', sum([k for i in word for k, v in Russian.items() if i in v]), 'очков')
